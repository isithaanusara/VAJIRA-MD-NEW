...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '' : process.env.VAJIRA-MD=fYk3XB7Z#TDgis9fGjqlKC55qz5yOwUnvYN8xtp-xQra3Ijh6r_s,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '' : process.env.94723259524,   
